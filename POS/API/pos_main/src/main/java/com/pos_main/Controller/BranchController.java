...
/**
 * Title: Branch.java. Company: www.softmacs.com Copyright: Copyright (c) 2018.
 * 
...
public class BranchController {
	...
	public ResponseDto gellAllBranchesBySBU(@RequestParam("sbuId") Integer sbuId) {
		...
		return branchService.gellAllBranchesBySbuId(sbuId);
	}
